...
weeklyUsage[0] = Math.random() * 10
weeklyUsage[1] = Math.random() * 10
weeklyUsage[2] = Math.random() * 10
weeklyUsage[3] = Math.random() * 10
...
fontLoader.load(
    ...
    (font) =>
    {
        ...
        textGeometry.translate(
            - (textGeometry.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[0] - 11 + textWeekdayX,
            - (textGeometry.boundingBox.max.y - .02) * 0.5 + weeklyUsage[0] + frondTextYoffset,
            - (textGeometry.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
    )
        ...
        textGeometry2.translate(
            - (textGeometry2.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[0] - 9 + textWeekdayX,
            - (textGeometry2.boundingBox.max.y - .02) * 0.5 + weeklyUsage[1] + frondTextYoffset,
            - (textGeometry2.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
    )
...
// day 3 label
       const textGeometry3 = new TextGeometry(
        ...
        textGeometry3.translate(
            - (textGeometry3.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[2] - 11 + textWeekdayX,
            - (textGeometry3.boundingBox.max.y - .02) * 0.5 + weeklyUsage[2] + frondTextYoffset,
            - (textGeometry3.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
    )
...
textGeometry4.translate(
    - (textGeometry4.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[3] - 11 + textWeekdayX,
    - (textGeometry4.boundingBox.max.y - .02) * 0.5 + weeklyUsage[3] + frondTextYoffset,
    - (textGeometry4.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
)
...
textGeometry5.translate(
    - (textGeometry5.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[4] - 11 + textWeekdayX,
    - (textGeometry5.boundingBox.max.y - .02) * 0.5 + weeklyUsage[4] + frondTextYoffset,
    - (textGeometry5.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
)
...
textGeometry6.translate(
    - (textGeometry6.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[5] - 11 + textWeekdayX,
    - (textGeometry6.boundingBox.max.y - .02) * 0.5 + weeklyUsage[5] + frondTextYoffset,
    - (textGeometry6.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
)
...
textGeometry7.translate(
    - (textGeometry7.boundingBox.max.x - .02) * 0.5 + cactusFrondsX[6] - 11+ textWeekdayX,
    - (textGeometry7.boundingBox.max.y - .02) * 0.5 + weeklyUsage[6] + frondTextYoffset,
    - (textGeometry7.boundingBox.max.z - .03) * 0.5 + textWeekdayZ
)
...
cactusLayer3Weekday.position.z = .5
// cactusTrunk.center()
...
cactusLayer3Weekend.position.z = -.5
// cactusTrunk.center()
...
function addSpikes(spikesizeX,spikesizeY,spikesizeZ,spikestartX,spikestartY,spikestartZ,spikeSpanX,spikeSpanY,spikeSpanZ,spikeCount,spikeLabel) {
...
addSpikes(0.2, 0.2, 0.2, -8, 5.2, 1.2, 9, .8, 0, 10)  // weekday bar
...
for (let i = 0; i < 7; i++) {
    addSpikes(0.2, 0.2, 0.2, cactusFrondsX[i] - 7.9, (weeklyUsage[i] * yRatio) + yOffset, weeklyUsageZ[i] + 1.15, .8, weeklyUsage[i], 0, Math.floor(weeklyUsage[i]))
}

for (let i = 0; i < 7; i++) {
    addSpikes(0.2, 0.2, 0.2, cactusFrondsX[i] - 7.9, (weeklyUsage[i] * yRatio) + yOffset, weeklyUsageZ[i] - .1, .8, weeklyUsage[i], 0, Math.floor(weeklyUsage[i]))
}
